...
module.exports = {
  ...
  module: {
    loaders: [
      {
        test: /\.css$/,
        loader: ExtractTextPlugin.extract('style-loader', 'css-loader?modules&importLoaders=1&localIdentName=draftJsPriorityTagPlugin__[local]__[hash:base64:5]!postcss-loader'),
      },
    ],
  },
