            ...
            success : function (data, text) {
                if (data.status.code == 200) {
                    ...
                    this.setState({
                        editOn : true,
                        editEventId : eventId,
                        defaultType : (data.event.type == 1 ? 'event' : 'task')
                    });
                ...
                <div className="calendar-main-row">
                    <div className="col-sm-9">
                        <div className="calender-view">
                                            ...
                                            <ul className="input-items-wrapper pull-right">
                                                ...
                                                <li>
                                                    <div className="btn-group">
                                                        ...
                                                        <button type="button" className={"menu-ico-group btn task " + (this.state.defaultType == 'task' ? "active" : null)} eventType="task" onClick={() => this.changeType('task')}>
                            ...
                            <div className="row task-list-area">
                                <div className="col-sm-12">
                                    <div className="task-list-area-content">
                                        <div className="task-list-area-content-title">
                                            <img src="/images/calender/icon-to-do.png" /><span>Tasks</span>
                                        </div>
                                        <div className="task-list-area-content-title-hr"></div>
                                        <DayTodosList
                                            events={this.state.events}
