...
export default class Index extends React.Component{
    ...
    constructor(props) {
        ...
        this.calenderType = 1;// 1 - PERSONAL_CALENDAR, 2 - GROUP_CALENDAR
    }
    ...
    relativeView() {
        ...
        switch(this.state.current) {
            ...
            case 'day':
                return  (<DayView calenderType={this.calenderType} dayDate={this.state.dayViewDate} selectedEvent={this.props.params.name} />);
            case 'month':
            ...
            default:
                return (<DayView calenderType={this.calenderType} dayDate={this.state.dayViewDate}/>);
        }
    }
