...
export default class NotificationPop extends React.Component{
    ...
    render(){
        ...
        return(
            <section className="notification-popup-wrapper">
...
export class Notifications extends React.Component {
    ...
    getNotificationText(notification) {
        ...
        switch(notification.notification_type) {
            ...
            case 'share_calendar' : return notification.sender_name + " has shared you a calendar event - " + notification.calendar_text;
